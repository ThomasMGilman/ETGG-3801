...
#ifdef MISSLECOMNDER_worldSpawner_generated_h
#error "worldSpawner.generated.h already included, missing '#pragma once' in worldSpawner.h"
#endif
...
public: \
	DECLARE_CLASS(AworldSpawner, AActor, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/MissleComnder"), NO_API) \
...
#define MissleComnder_Source_MissleComnder_worldSpawner_h_14_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, AworldSpawner); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(AworldSpawner); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API AworldSpawner(AworldSpawner&&); \
	NO_API AworldSpawner(const AworldSpawner&); \
public:
...
template<> MISSLECOMNDER_API UClass* StaticClass<class AworldSpawner>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID MissleComnder_Source_MissleComnder_worldSpawner_h
