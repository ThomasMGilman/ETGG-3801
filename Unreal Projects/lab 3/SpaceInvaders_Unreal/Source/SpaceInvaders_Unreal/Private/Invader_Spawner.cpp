...
#include "Invader_Spawner.h"
#include "Components/SphereComponent.h"

// Sets default values
AInvader_Spawner::AInvader_Spawner() : forward_time(0.0f), moving_left(true)
{
...
void AInvader_Spawner::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AInvader_Spawner::Tick(float DeltaTime)
{
